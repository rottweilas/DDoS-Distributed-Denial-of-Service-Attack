...
#darkDDoS_themedict = {'BACKGROUND': '#000', 'TEXT': '#FF3333','INPUT': '#000','TEXT_INPUT': '#FF3333', 'SCROLL': '#FF3333','BUTTON': ('#FF3333', '#000'),'PROGRESS': ('#FF3333', '#000'), 'BORDER': 1,'SLIDER_DEPTH': 1,'PROGRESS_DEPTH': 0}
...
layout =    [[sg.Text('Contact: rottweilasdev@gmail.com')],
            ...
            [sg.Text('INFO: ', size=(9, 1)), sg.Input(disabled = True,  key='-txtOutput-')],
            [sg.Button('Remove', tooltip = 'Remove selected IP.'), sg.Button('Attack', tooltip = 'Start attack.'), sg.Button('Stop', tooltip = 'Stop attack.'), sg.Button('Support', tooltip = 'Get help.')]]
          
window = sg.Window('DDoS by rottweilas', layout, element_justification='c', web_debug=True)
ipIndex = 0
counter = 0
cntr = 0
timeout = False
